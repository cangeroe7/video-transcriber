      ...
      <DialogContent className="sm:max-w-[600px]">
        ...
        <div className="grid gap-4 py-4">
          ...
          {showVideos && (
            <div
              draggable={false}
              className="grid max-h-60 grid-cols-3 gap-4 overflow-y-auto"
            >
              {videos
                ? videos.map((video: VideoWithMedia) => (
                    <div
                      key={video.id}
                      className={`align-center relative cursor-pointer overflow-hidden rounded-lg transition-all ${
                        selectedVideos.includes(video)
                          ? "scale-90 transform shadow-lg ring-2 ring-primary"
                          : ""
                      }`}
                    ...
                    >
                      <Image
                        ...
                        draggable={false}
                      />
                      <div className="bg-gray-700 px-2 py-1 text-center text-white">
